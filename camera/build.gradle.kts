...
val basePackage = "$libraryGroup.camera"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "camera", version.toString())

    pom {
        name = "KMPToolkit camera"
        description = "A library for camera Kotlin Multiplatform."
        inceptionYear = "2025"
