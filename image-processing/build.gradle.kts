...
val basePackage = "$libraryGroup.image.processing"
...
mavenPublishing {
    ...
    coordinates(group.toString(), "image-processing", version.toString())

    pom {
        name = "KMPToolkit image processing"
        description = "A library for image priocessing in Kotlin Multiplatform."
        inceptionYear = "2025"
